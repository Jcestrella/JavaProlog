...
public class ProyectoJPL {
    public static void main(String[] args) {
     ...
     String t8 = ("sintomas(Y).");    
     Query q8 = new Query(t8);
	String action = q8.oneSolution().get("Y").toString();
     System.out.println(t8 + " " + (q8.hasSolution() ? "No hay resultados en la base de datos"
             : "Todos los sintomas"));
	System.out.println("Uno de los sintomas es "+ action);
     System.out.println("-------------------------------------------");
}
}
